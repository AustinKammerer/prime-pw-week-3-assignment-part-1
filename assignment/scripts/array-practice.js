...
let favFoods = ["lasagna", "steak", "curry", "sushi", "apple pie"];
...
favFoods.unshift("avacado toast");
console.log(`Added a food to the beginning: ${favFoods}`);
